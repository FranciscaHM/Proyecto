...
\begin{description}       % Agrega tus referencias siguiendo los ejemplos
 ...
 \item Plait, M. (2016, 3 febrero). Sometimes They Come Back: Giant Gas Cloud on Collision Course With the Milky Way. Slate. 
...
\center{
   ...
   {\bf }. \\
   \includegraphics[width=4cm,angle=0]{fig1.png}
}
